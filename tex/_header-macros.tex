...
\newcommand{\ketOrbitalTB}[1]{\Ket{ϕ_{τ \s}^{#1} \ofK}}
\newcommand{\ketOrbitalK}[1]{\Ket{v_{τ \s}^{#1} \ofK}}
\newcommand{\ketOrbitalKPhi}[1]{\Ket{v_{τ \s}^{#1} \ofKPhi}}
\newcommand{\ketEigenstateTB}[1]{\Ket{ψ_{τ \s}^{#1} \ofK}}
\newcommand{\ketEigenstateK}[1]{\Ket{u_{τ \s}^{#1} \ofK}}
\newcommand{\ketEigenstateKPhi}[1]{\Ket{u_{τ \s}^{#1} \ofKPhi}}

% Partials
\newcommand{\sumKP}{\sideset{}{'}∑_{\vK'}}
\newcommand{\sumInt}{∑_{α, β, δ, γ}} % chktex 19

% TODO: Remove this and all todos.
